...
//                   onTap: () {
//                     Get.back();
//                     Get.find<HomeController>().getPolylineAndMarker(
//                         province: controller.listProvinces[index]);
//                     Get.find<DashboardController>().handleTabController(
...
//             itemCount: controller.listProvinces.leng