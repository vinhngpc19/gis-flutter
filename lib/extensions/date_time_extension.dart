extension DateTimeEx on DateTime {
    ...
    return format.replaceAllMapped(
      ...
      (Match m) {
        switch (m.group(0)) {
          ...
          case 'MMM':
            return shortMonths[month.toString().padLeft(2, '0')]!;
          case 'MMMM':
            return fullMonths[month.toString().padLeft(2, '0')]!;
          case 'yyyy':
          ...
          case 'EEE':
            return shortDays[weekday.toString()]!;
          case 'EEEE':
            return fullDays[weekday.toString()]!;
          default:
            return m.group(0)!;
        }
      },
  ...
  String timeAgo(
    ...
    if (seconds < 5) {
      ...
      return '${_formatUnit(seconds, abbreviatedUnits, 'second')} ago';
    } else if (minutes < 60) {
      return '${_formatUnit(minutes, abbreviatedUnits, 'minute')} ago';
    } else if (hours < 24) {
